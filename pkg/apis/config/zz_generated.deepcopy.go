...
func (in *AzureConfiguration) DeepCopyInto(out *AzureConfiguration) {
	*out = *in
	if in.PublicIPRemedy != nil {
		in, out := &in.PublicIPRemedy, &out.PublicIPRemedy
		*out = new(AzurePublicIPRemedyConfiguration)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzurePublicIPRemedyConfiguration) DeepCopyInto(out *AzurePublicIPRemedyConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzurePublicIPRemedyConfiguration.
func (in *AzurePublicIPRemedyConfiguration) DeepCopy() *AzurePublicIPRemedyConfiguration {
	if in == nil {
		return nil
	}
	out := new(AzurePublicIPRemedyConfiguration)
